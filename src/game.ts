...
const transform2 = new Transform({
  position: new Vector3(30.5, 0, 8),
  rotation: new Quaternion(-2.996864400790864e-15, -0.7071067094802856, 8.195637946073475e-8, -0.70710688829422),
...
const transform3 = new Transform({
  ...
  scale: new Vector3(5.062532901763916, 5.0625, 2.5)
})
